            ...
            <tr>
                ...
                <div>
                    <input
                        ...
                        name="CapitalExpenses[${row}][ProfessionalServices]"
                ...
                <td>
                  <div>
                    <input
                        ...
                        name="CapitalExpenses[${row}][ThirdParty]"
...
function addRowToFutureDecom(element) {
    ...
    let newTr = `
        <tr>
            ...
            <td>
                <input value="0" class="form-control input1" name="FutureDecommissions[${row}].EstimatedSaving"/>
            </td>
            <td>
